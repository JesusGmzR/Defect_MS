...
router.post('/', async (req, res) => {
  try {
    ...
    // Insertar en la base de datos (fecha se auto-genera con CURRENT_TIMESTAMP)
    const query = `
      INSERT INTO defect_data 
      (id, linea, codigo, defecto, ubicacion, area, modelo, tipo_inspeccion, etapa_deteccion, registrado_por)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `;
    
    await db.execute(query, [
      id, linea, codigo, defecto, ubicacion, area, modelo || '',
